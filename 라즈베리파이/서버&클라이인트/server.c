...
#define MAX_CLNT        32
#define ID_SIZE         10
#define ARR_CNT         7 // 명령어의 인자의 최대 개수
...
int main(int argc, char* argv[])
{
        ...
        CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","PDW_LIN","PASSWD"}, \
                {0,-1,"","PDW_BT","PASSWD"},  {0,-1,"","PDW_WIFI","PASSWD"}, \
                {0,-1,"","PDW_AND","PASSWD"},  {0,-1,"","PDW_SQL","PASSWD"}, \
                {0,-1,"","PRJ_WIFI1","PASSWD"},  {0,-1,"","PRJ_BT","PASSWD"}, \
                {0,-1,"","PRJ_SQL","PASSWD"},  {0,-1,"","9","PASSWD"}, \
        ...
        serv_sock = socket(PF_INET, SOCK_STREAM, 6/*0도 가능*/);
        ...
        while(1)
        {
                ...
                else if(clnt_sock < 0) // 첫번째 클라이언트 연결 오류시
                {
                        perror("accept()");
                        continue;
                }
